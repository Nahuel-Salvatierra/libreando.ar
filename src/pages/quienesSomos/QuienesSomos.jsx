  ...
  return (
    <div>
      <section className='container bg-light'>
        <div className='quienesSomos m-0 text-center bg-naranja-claro'>
          {/* Quienes Somos */}
          <div>
            <h2> ¿Quienes somos?</h2>
            <p>En <strong>LibreAndo</strong>, nos enorgullece ser un referente en la comunidad cuando se trata de brindar apoyo y bienestar a través de nuestros talleres y servicios terapéuticos. Fundada con una visión de transformar vidas y promover el crecimiento personal, nuestra institución se ha convertido en un faro de esperanza y positividad para quienes buscan alcanzar su máximo potencial.</p>
          </div>
        </div>
        {/* Nuestra mision */}
        <Cards
